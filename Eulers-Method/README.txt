...
Math 2605 G1 
Project 5: Euler Method


Here you can find the entire project as well as a runnable jar. If for some reason the jar doesn't work, the project can be easily imported into eclipse as an existing project. Run JacobiApp.java and you should have no problem getting things working. However, that should not be necessary.
...
NOTE: The app has been crashing on me on occasion, so it may need to be restarted.
